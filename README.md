...
| `2022` | `CASE` | [Object-based Loop Closure with Directional Histogram Descriptor](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9926687) | [![Code](https://github.com/benchun123/object-based-loop-closure?tab=readme-ov-file)] |
...
| `2021` | `RA-L` | [Semantic histogram based graph matching for real-time multi-robot global localization in large scale environment](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=9353207) | [![Code](https://github.com/gxytcrc/semantic-histogram-based-global-localization)] |
